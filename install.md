...
```
yay -S firefox-i18n-fr firefox-ublock-origin vlc ffmpegthumbnailer evince xarchiver galculator pavucontrol pulseaudio-{alsa,bluetooth} blueman libcanberra-{pulse,gstreamer} system-config-printer
```
